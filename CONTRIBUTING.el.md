# Συνεισφορά στο clawclawclaw

Σας ευχαριστούμε για το ενδιαφέρον σας να συνεισφέρετε στο clawclawclaw! Αυτός ο οδηγός θα σας βοηθήσει να ξεκινήσετε.
...
1. **Βρείτε ένα ζήτημα.** Αναζητήστε ζητήματα με την ετικέτα [`good first issue`](https://github.com/CSZHK/clawcalwclaw/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) — αυτά είναι σχεδιασμένα για νεοεισερχόμενους και περιλαμβάνουν το απαραίτητο πλαίσιο για να ξεκινήσετε γρήγορα.
...
Το clawclawclaw υποστηρίζει κλιμακωτή διαχείριση μυστικών για την τοπική ανάπτυξη και την υγιεινή του CI.
...
2. **Αρχείο ρυθμίσεων** (`~/.clawclawclaw/config.toml`)
...
3. Γενικές μεταβλητές περιβάλλοντος (`CLAWCLAWCLAW_API_KEY`, `API_KEY`)
...
**clawclawclaw** — Μηδενική επιβάρυνση. Κανένας συμβιβασμός. 🦀
