...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=CLAWCLAWCLAW_GIT_SHORT_SHA");
    ...
    let short_sha = env::var("CLAWCLAWCLAW_GIT_SHORT_SHA")
        .ok()
    ...
    println!("cargo:rustc-env=CLAWCLAWCLAW_BUILD_VERSION={build_version}");
    println!(
        "cargo:rustc-env=CLAWCLAWCLAW_GIT_SHORT_SHA={}",
