...
//!
//! A standalone robotics toolkit that integrates with clawclawclaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  clawclawclaw AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use clawclawclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of clawclawclaw. It defines its own
//! `Tool` trait that is compatible with clawclawclaw's but doesn't require it.
//!
//! ## Safety
//!
