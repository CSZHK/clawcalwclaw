# Audit Logging for clawclawclaw
...
## Problem
clawclawclaw logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/clawclawclaw/audit.key"
...
clawclawclaw audit --user @alice

# Show all high-risk commands
clawclawclaw audit --risk high

# Show violations from last 24 hours
clawclawclaw audit --since 24h --violations-only

# Export to JSON for analysis
clawclawclaw audit --format json --output audit.json
