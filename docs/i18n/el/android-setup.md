...
Το clawclawclaw παρέχει προκατασκευασμένα εκτελέσιμα αρχεία (binaries) για συσκευές Android.
...
Ο ευκολότερος τρόπος εκτέλεσης του clawclawclaw σε Android είναι μέσω [Termux](https://termux.dev/).
...
Για προχωρημένους χρήστες που θέλουν να εκτελέσουν το clawclawclaw εκτός Termux:
