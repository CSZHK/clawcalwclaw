...
Αυτός ο οδηγός περιγράφει τη διαδικασία διαμόρφωσης των καναλιών επικοινωνίας (Telegram, Discord, κ.λπ.) στο clawclawclaw.
...
Οι ρυθμίσεις αποθηκεύονται στο αρχείο `~/.clawclawclaw/config.toml`, στην ενότητα `[channels_config]`.
...
Σε πλατφόρμες όπως το Telegram και το Discord, μπορείτε να ελέγχετε το clawclawclaw με εντολές:
...
Το clawclawclaw υποστηρίζει την ανάγνωση εικόνων μέσω της σύνταξης:
`[IMAGE:<source>]`
...
5. **Επανεκκίνηση**: Κάθε αλλαγή στο `config.toml` απαιτεί επανεκκίνηση του `clawclawclaw daemon`.

### Διαγνωστικά Μηνύματα (Logs)

Εκτελέστε το clawclawclaw με αυξημένο επίπεδο καταγραφής:
```bash
