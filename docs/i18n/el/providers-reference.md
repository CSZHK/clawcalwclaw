# Αναφορά Παρόχων clawclawclaw (Providers Reference)
...
Το runtime του clawclawclaw αναζητά διαπιστευτήρια με την εξής σειρά προτεραιότητας:
...
3. **Γενικές μεταβλητές**: Εφεδρικές μεταβλητές όπως οι `CLAWCLAWCLAW_API_KEY` ή `API_KEY`.
...
- Τα μοντέλα συλλογιστικής (thinking models) υποστηρίζονται εγγενώς· το clawclawclaw φιλτράρει αυτόματα τα εσωτερικά metadata της συλλογιστικής.
...
Κλήση μέσω CLI: `clawclawclaw agent --model hint:fast --message "..."`.
