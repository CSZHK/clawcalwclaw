...
- Το CLI `clawclawclaw sop` διαχειρίζεται αυτή τη στιγμή μόνο ορισμούς: `list`, `validate`, `show`.
...
2. Δημιουργήστε έναν κατάλογο SOP, για παράδειγμα:
   ...
   ```text
   ~/.clawclawclaw/workspace/sops/deploy-prod/SOP.toml
   ~/.clawclawclaw/workspace/sops/deploy-prod/SOP.md
   ```

3. Επαλήθευση και επιθεώρηση ορισμών:

   ```bash
   clawclawclaw sop list
   clawclawclaw sop validate
   clawclawclaw sop show deploy-prod
   ```
