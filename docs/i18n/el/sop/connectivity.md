...
Το clawclawclaw δρομολογεί συμβάντα MQTT/webhook/cron/περιφερειακών μέσω ενός ενοποιημένου SOP dispatcher (`dispatch_sop_event`).
...
client_id = "clawclawclaw-agent-1"
...
| **Το Cron δεν εκκινεί** | daemon δεν εκτελείται ή μη έγκυρη έκφραση | εκτελέστε `clawclawclaw daemon`· ελέγξτε logs για προειδοποιήσεις ανάλυσης cron |
