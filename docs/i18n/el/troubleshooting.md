...
Αυτός ο οδηγός περιγράφει λύσεις για κοινά ζητήματα εγκατάστασης και εκτέλεσης του clawclawclaw.
...
clawclawclaw doctor
```
Ελέγξτε τις ρυθμίσεις στο `~/.clawclawclaw/config.toml`:
...
Ελέγξτε την κατάσταση μέσω του clawclawclaw CLI:
```bash
