...
- [H3 · 1.1 Proxy only clawclawclaw internal traffic](../../proxy-agent-playbook.md#1-1-proxy-only-clawclawclaw-internal-traffic)
...
- [H2 · 4. Mode A — Proxy Only for clawclawclaw Internals](../../proxy-agent-playbook.md#4-mode-a-proxy-only-for-clawclawclaw-internals)
