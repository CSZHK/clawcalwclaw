...
|---------|-----------|--------------|--------|
| **clawclawclaw cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | clawclawclaw (cơ bản) | clawclawclaw (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, clawclawclaw chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của clawclawclaw: hoán đổi bất kỳ thứ gì
