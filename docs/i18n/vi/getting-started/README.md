...
| Tình huống | Lệnh |
|----------|---------|
| Có API key, muốn cài nhanh nhất | `clawclawclaw onboard --api-key sk-... --provider openrouter` |
| Muốn được hướng dẫn từng bước | `clawclawclaw onboard --interactive` |
| Đã có config, chỉ cần sửa kênh | `clawclawclaw onboard --channels-only` |
...
- Thiết lập nhanh: `clawclawclaw onboard --api-key "sk-..." --provider openrouter`
- Thiết lập tương tác: `clawclawclaw onboard --interactive`
- Kiểm tra môi trường: `clawclawclaw status` + `clawclawclaw doctor`
