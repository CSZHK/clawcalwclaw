...
Cách cài đặt và khởi tạo clawclawclaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài clawclawclaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image clawclawclaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.clawclawclaw-docker`.
