...
clawclawclaw currently uses in-process trait/factory extension points for providers, tools, channels, memory, runtime adapters, observers, peripherals, and hooks. Hook interfaces exist, but several lifecycle events are either missing or not wired in runtime paths.
...
Define separate contracts under `wit/clawclawclaw/`:
- `hooks/v1`
- `tools/v1`
- `providers/v1`
