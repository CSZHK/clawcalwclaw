...
existing clawclawclaw traits/factories.
...
- Create: `wit/clawclawclaw/hooks/v1/*.wit`
- Create: `wit/clawclawclaw/tools/v1/*.wit`
- Create: `wit/clawclawclaw/providers/v1/*.wit`
...
fn manifest_rejects_incompatible_wit_major() {
    let m = PluginManifest { wit_package: "clawclawclaw:hooks@2.0.0".into(), ..Default::default() };
