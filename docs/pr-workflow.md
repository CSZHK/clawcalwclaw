# clawclawclaw PR Workflow (High-Volume Collaboration)

This document defines how clawclawclaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to clawclawclaw/project-native labels.
...
- Confirm any required identity-like wording uses clawclawclaw/project-native terminology.
