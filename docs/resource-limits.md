# Resource Limits for clawclawclaw
...
## Problem
clawclawclaw has rate limiting (20 actions/hour) but no resource caps. A runaway agent could:
...
Automatically create a cgroup for clawclawclaw with limits.
