...
Scammers may impersonate clawclawclaw maintainers, contributors, or community members.

Assume fraud if someone claiming to represent clawclawclaw asks for:
...
clawclawclaw maintainers do not request money or private wallet/financial credentials via direct messages.

## Official Sources Of Truth

Use these sources to verify announcements:

- GitHub repository: `CSZHK/clawcalwclaw`
...
3. Open a GitHub issue in `CSZHK/clawcalwclaw` with sanitized details.
