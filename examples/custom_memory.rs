//! Example: Implementing a custom Memory backend for clawclawclaw
//!
...
// ── Re-define the trait types (in your app, import from clawclawclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 clawclawclaw Memory Demo — InMemoryBackend\n");
