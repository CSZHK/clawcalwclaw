# clawclawclaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for clawclawclaw edge scenarios on ESP32.
...
```text
firmware/clawclawclaw-esp32-ui/
...
```bash
cd firmware/clawclawclaw-esp32-ui
cargo build --release
...
3. Connect UI state with clawclawclaw edge/runtime messaging
...
- [clawclawclaw Hardware Design](../../docs/hardware-peripherals-design.md)
