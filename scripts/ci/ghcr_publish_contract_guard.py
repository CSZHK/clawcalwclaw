...
POLICY_SCHEMA = "clawclawclaw.ghcr-tag-policy.v1"
...
def fetch_manifest(repository: str, tag: str, token: str) -> dict[str, object]:
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "clawclawclaw-ghcr-publish-contract-guard/1",
        },
        method="GET",
    )
...
def main() -> int:
    ...
    parser.add_argument("--repository", required=True, help="Repository path for GHCR API, e.g. CSZHK/clawcalwclaw")
    ...
    report = {
        "schema_version": "clawclawclaw.ghcr-publish-contract.v1",
