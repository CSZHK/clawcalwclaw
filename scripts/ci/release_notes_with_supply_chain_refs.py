...
REQUIRED_REFERENCES = {
    ...
    "sbom_cyclonedx": "clawclawclaw.cdx.json",
    "sbom_spdx": "clawclawclaw.spdx.json",
    "checksums_provenance": "clawclawclaw.sha256sums.intoto.json",
...
def main() -> int:
    ...
    report: dict[str, object] = {
        "schema_version": "clawclawclaw.release-notes-supply-chain.v1",
