...
const repoBase = "https://github.com/CSZHK/clawcalwclaw/blob/main";
const rawBase = "https://raw.githubusercontent.com/CSZHK/clawcalwclaw/main";
...
const readingPaths: Array<{
  ...
  {
    id: "newcomer",
    label: { en: "New to clawclawclaw", zh: "初次了解 clawclawclaw" },
    detail: {
  ...
  },
  {
    ...
    detail: {
      en: "Connect clawclawclaw with chat platforms and external providers.",
      zh: "将 clawclawclaw 接入聊天平台与外部模型能力。",
    },
...
const copy = {
  en: {
    ...
    notice:
      "Official source channels: use this repository as the source of truth ",
  ...
  zh: {
    ...
    startHereTitle: "新手起步",
    startHereLead: "面向首次接触 clawclawclaw 的核心文档，快速完成有效上手。",
  ...
  return (
    <div className="zc-app">
      <header className="topbar">
        <div className="topbar-inner">
          ...
          <nav className="top-nav" aria-label="Primary">
            ...
            <a href="https://github.com/CSZHK/clawcalwclaw" target="_blank" rel="noreferrer">
              {text.navGitHub}
            </a>
            <a href="https://github.com/CSZHK/clawcalwclaw" target="_blank" rel="noreferrer">
              {text.navWebsite}
      ...
      <footer className="footer">
        <p>
          clawclawclaw · Trait-driven architecture · secure-by-default runtime ·
