...
/// <FunctionCall>
/// file_read
/// <code>path>/Users/kylelampa/Documents/clawclawclaw/README.md</code>
/// </FunctionCall>
/// ```
...
/// Map tool name aliases from various LLM providers to clawclawclaw tool names.
...
/// to. This function encodes the mapping for known clawclawclaw tools.
...
pub(super) fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. clawclawclaw tool-call tags (<tool_call>, <toolcall>, <tool-call>)
