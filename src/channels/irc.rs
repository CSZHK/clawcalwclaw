...
/// and forwards PRIVMSG messages to the `clawclawclaw` message bus.
...
impl Channel for IrcChannel {
    ...
    async fn listen(&self, tx: mpsc::Sender<ChannelMessage>) -> anyhow::Result<()> {
        ...
        Self::send_raw(
            &mut writer,
            &format!("USER {} 0 * :clawclawclaw", self.username),
        )
        .await?;
...
mod tests {
    ...
    fn new_stores_all_fields() {
        let ch = IrcChannel::new(IrcChannelConfig {
            ...
            port: 6697,
            nickname: "zcbot".into(),
            username: Some("clawclawclaw".into()),
        ...
        assert_eq!(ch.username, "clawclawclaw");
    ...
    fn irc_config_serde_roundtrip() {
        ...
        assert_eq!(parsed.username.as_deref(), Some("clawclawclaw"));
...
"#;
    ...
    fn make_channel() -> IrcChannel {
        IrcChannel::new(IrcChannelConfig {
            ...
            nickname: "zcbot".into(),
            username: None,
            channels: vec!["#clawclawclaw".into()],
