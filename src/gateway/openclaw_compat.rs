...
//!
//! Provides two endpoints for callers migrating from OpenClaw to clawclawclaw:
//!
//! 1. **`POST /api/chat`** (recommended) — clawclawclaw-native endpoint that invokes the
...
//! clawclawclaw's existing `/v1/chat/completions` (in `openai_compat.rs`) uses the
...
// ══════════════════════════════════════════════════════════════════════════════
// /api/chat — clawclawclaw-native endpoint
// ══════════════════════════════════════════════════════════════════════════════
...
pub struct ApiChatBody {
    ...
    /// Use this to inject recent conversation history that clawclawclaw's
...
/// `POST /v1/chat/completions` — OpenAI-compatible shim over clawclawclaw's agent loop.
///
...
/// the same tools + memory experience as native clawclawclaw channels.
