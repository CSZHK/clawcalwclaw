//! Flash clawclawclaw Arduino firmware via arduino-cli.
//!
...
/// Flash clawclawclaw firmware to Arduino at the given port.
pub fn flash_arduino_firmware(port: &str) -> Result<()> {
    ...
    // Compile
    println!("Compiling clawclawclaw Arduino firmware...");
    ...
    println!("clawclawclaw firmware flashed successfully.");
