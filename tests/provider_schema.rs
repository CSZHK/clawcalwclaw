...
use clawclawclaw::providers::compatible::AuthStyle;
use clawclawclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use clawclawclaw::providers::compatible::OpenAiCompatibleProvider;
